...
public class GetRequest_002 extends Base {

	@BeforeClass
	public void setUp() {
		
		logger.info("**********GetRequest_002_Started*************");
		logger.info("**********Get_A_Particular_Empolyee***********");
		RestAssured.baseURI = "https://dummy.restapiexample.com/api/v1";
		
		httpRequest = RestAssured.given();
		
		response = httpRequest.request(Method.GET,"/employee/15");
	}
	...
	public void checkContentEncoding() {
		...
		String actualContentEncoding = "br";
